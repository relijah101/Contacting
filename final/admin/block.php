...
$table_name = "users";
  ...
  $query="UPDATE $table_name SET status='0' WHERE id='$_GET[id]'";
...
<html>
  <head>
    ...
    <body class="ui-widget">
      <h1 class="ui-widget-header">Blocked Users</h1>
 ...
 <?php
   ...
   <td style="text-align:center;">
      <a class='action' href="admin.php?id=<?php echo $row['id']; ?>"> unblock</a>
    </td>
  </tr>
    <?php
   }
